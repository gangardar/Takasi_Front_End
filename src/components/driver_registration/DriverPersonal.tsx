...
const DriverPersonal = () => {
  ...
  return (
    <>
      <p className="h4 text-center text-info mb-2">Driver Registeration</p>
      {createDriver.error && (
        <div className="alert alert-danger">{createDriver.error.message}</div>
      )}
        ...
        >
          ...
          {(errors.current_latitude || errors.current_longitude) && (
            <div className="mb-3">
              ...
              <p className="text-danger">
                {errors.current_longitude?.message};
              </p>
            </div>
          )}
